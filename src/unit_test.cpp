...
void _check_equal(const char* file, int line, int64_t expected, int64_t actual)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "Expected: %lld  Actual: %lld", expected, actual);
...
void _check_not_equal(const char* file, int line, int64_t expected, int64_t actual)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "Actual value equals expected: %lld", actual);
        fail(file,line,buffer);
    }
}
void _check_less_than(const char* file, int line, int64_t left, int64_t right)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "%lld is not less than %lld", left, right);
        fail(file,line,buffer);
    }
}
void _check_greater_than(const char* file, int line, int64_t left, int64_t right)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "%lld is not greater than %lld", left, right);
        fail(file,line,buffer);
    }
}
...
void _check_equal_pointer(const char* file, int line, const void* expected, const void* actual)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "Expected: %p  Actual: %p", expected, actual);
        fail(file,line,buffer);
    }
}
void _check_not_equal_pointer(const char* file, int line, const void* expected, const void* actual)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "Actual value equals expected: %p", actual);
        fail(file,line,buffer);
    }
}
void _check_null(const char* file, int line, const void* pointer)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "Pointer is not NULL: %p", pointer);
        fail(file,line,buffer);
    }
}
void _check_not_null(const char* file, int line, const void* pointer)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "Pointer is NULL");
        fail(file,line,buffer);
    }
}
...
void _check_equal_float(const char* file, int line, double expected, double actual)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "Expected: %f  Actual: %f", expected, actual);
        fail(file,line,buffer);
    }
}
void _check_not_equal_float(const char* file, int line, double expected, double actual)
{
    if(fabs(expected - actual) < 0.0000f)
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "Actual value equals expected: %f", actual);
        fail(file,line,buffer);
    }
}
void _check_less_than_float(const char* file, int line, double left, double right)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "%f is not less than %f", left, right);
        fail(file,line,buffer);
    }
}
void _check_greater_than_float(const char* file, int line, double left, double right)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "%f is not greater than %f", left, right);
        fail(file,line,buffer);
    }
}
...
void _check_equal_string(const char* file, int line, const char* expected, const char* actual)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "Expected: %s  Actual: %s", expected, actual);
        fail(file,line,buffer);        
    }
}
void _check_not_equal_string(const char* file, int line, const char* expected, const char* actual)
{
    ...
    {
        char buffer[256];
        snprintf(buffer, sizeof(buffer), "Strings are equal: %s", actual);
        fail(file,line,buffer);        
    }
}
